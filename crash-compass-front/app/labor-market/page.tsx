...
export default function LaborMarketPage() {
    ...
    const [filteredCharts, setFilteredCharts] = useState(laborCharts);
    useEffect(() => {
        ...
        <main className="max-w-5xl mx-auto px-4 py-10">
            ...
            <div className="mt-16">
                <div className="border-t border-gray-200 pt-8">
                    <h2 className="text-2xl font-bold mb-6">Labor Market Data Charts</h2>
                    <ChartSearch charts={laborCharts} onFilteredChartsChange={setFilteredCharts} />
